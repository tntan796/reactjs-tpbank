    ...
    return (
        <div className="content-wrap">
            <div className="device-content">
                <div className="title">
                    <img src="https://ebank.tpb.vn/retail/vX/assets/icons/ic_device_lock.svg" />
                    <p>Các thiết bị quý khách từng sử dụng để đăng nhập vào ebank</p>
                </div>
                <div className="device-items">
                    <div className="item">
                        <img src="https://ebank.tpb.vn/retail/vX/assets/icons/ic_device_web.svg" />
                        <div className="info">
                            <p>Chrome</p>
                    ...
                    <div>
                        <div className="item">
                            <img src="https://ebank.tpb.vn/retail/vX/assets/icons/ic_device_mobile.svg" />
                            <div className="info">
                                <p>M2010J19CG</p>
