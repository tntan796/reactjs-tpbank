        ...
        <div className="content-wrap">
            <div className="change-password-container">
                <form className="change-passwrod-form ng-untouched ng-pristine ng-invalid" noValidate>
                    ...
                    <div>
                        <div className="app-form-field">
                            <div className="change-passwrod-form__wrap-old-password"><input autoCapitalize="off" autoComplete="off" autoCorrect="off" className="app-input-default change-passwrod-form__input-old-pass ng-untouched ng-pristine ng-invalid" formcontrolname="currentPass" nonaccented spellCheck="off" type="password" placeholder="Mật khẩu" />
                                <img src="https://ebank.tpb.vn/retail/vX/assets/icons/icons_eye.svg" />
                                <img hidden src="https://ebank.tpb.vn/retail/vX/assets/icons/icons_unEye.svg" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="app-form-field">
                            <div className="change-passwrod-form__wrap-new-password"><input autoCapitalize="off" autoComplete="off" autoCorrect="off" className="app-input-default change-passwrod-form__input-new-pass ng-untouched ng-pristine ng-invalid" formcontrolname="newPass" nonaccented spellCheck="off" type="password" placeholder="Mật khẩu" />
                                <img src="https://ebank.tpb.vn/retail/vX/assets/icons/icons_eye.svg" />
                                <img hidden src="https://ebank.tpb.vn/retail/vX/assets/icons/icons_unEye.svg" />
                            </div>
                        </div>
                    ...
                    <div className="change-passwrod-form__wrap-text-hint">
                        <div className="change-passwrod-form__text-hint">
                            <img alt="" src="https://ebank.tpb.vn/retail/vX/assets/icons/ic_check_bold.svg" width={12} />
                            <span>Ít nhất 8 ký tự</span>
                        </div>
                        <div className="change-passwrod-form__text-hint" style={{ display: 'flex' }}>
                            <img alt="" src="https://ebank.tpb.vn/retail/vX/assets/icons/ic_check_bold.svg" style={{ height: 'fit-content' }} width={12} />
